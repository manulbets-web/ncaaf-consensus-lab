# NCAAF Consensus Lab v3.6.6 — Manual Cohort + Market Shelf

v3.6.6 reframes the production workflow around a fixed, interpretable cohort rather than exhaustive combination search.
...
## v3.6.6 exact historical cohort bet audit
